class PhysiciansController < ApplicationController
  ...
  private
    ...
    def physician_params
      params.require(:physician).permit(:name, :specialty, officelocs_attributes: [:id, :address, :zip, :phone, :_destroy], appointments_attributes: [:id, :visit, :_destroy], 
      patients_attributes: [:id, :name, :_destroy])
    end
end
